...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'sherlocklau', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A UI designer.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sherlocklau.cc', // 网站地址
